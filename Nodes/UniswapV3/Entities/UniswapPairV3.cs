...
namespace NodeBlock.Plugin.Ethereum.Nodes.UniswapV3.Entities
{
    class UniswapPairV3
    {
        public partial class UniswapPairDeploymentV3 : UniswapPairDeploymentBaseV3
        {
            public UniswapPairDeploymentV3() : base(BYTECODE) { }
            public UniswapPairDeploymentV3(string byteCode) : base(byteCode) { }
        }

        public class UniswapPairDeploymentBaseV3 : ContractDeploymentMessage
        {
            public static string BYTECODE = "";
            public UniswapPairDeploymentBaseV3() : base(BYTECODE) { }
            public UniswapPairDeploymentBaseV3(string byteCode) : base(byteCode) { }
