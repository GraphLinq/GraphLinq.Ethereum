...
{
    [NodeDefinition("OnUniswapSyncNode", "On Uniswap Sync", NodeTypeEnum.Event, "Uniswap")]
    ...
    public class OnUniswapSyncNode : Node, IEventEthereumNode
    {
        public OnUniswapSyncNode(string id, BlockGraph graph)
          : base(id, graph, typeof(OnUniswapSyncNode).Name)
        {
