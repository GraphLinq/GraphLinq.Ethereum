...
namespace NodeBlock.Plugin.Ethereum.Nodes.Uniswap.Entities
{
    class UniswapPair
    {
        ...
        {
            public UniswapPairDeployment() : base(BYTECODE) { }
            public UniswapPairDeployment(string byteCode) : base(byteCode) { }
        }

        public class UniswapPairDeploymentBase : ContractDeploymentMessage
        {
            public static string BYTECODE = "";
            public UniswapPairDeploymentBase() : base(BYTECODE) { }
            public UniswapPairDeploymentBase(string byteCode) : base(byteCode) { }
