...
{
    [NodeDefinition("GetGlqTransactionParametersNode", "Get GLQ Transaction Parameters", NodeTypeEnum.Function, "Blockchain.GraphLinq")]
    [NodeGraphDescription("Parse the last GLQ transaction object received into string out parameters readable")]
    public class GetGlqTransactionParametersNode : Node
    {
        public GetGlqTransactionParametersNode(string id, BlockGraph graph)
            : base(id, graph, typeof(GetGlqTransactionParametersNode).Name)
        {
