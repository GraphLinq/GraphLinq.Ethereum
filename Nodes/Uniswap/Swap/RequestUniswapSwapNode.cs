...
using static NodeBlock.Plugin.Ethereum.Nodes.Uniswap.Entities.UniswapFactoryV2;
using static NodeBlock.Plugin.Ethereum.Nodes.Uniswap.Entities.UniswapPair;
using static NodeBlock.Plugin.Ethereum.Nodes.Uniswap.Entities.UniswapRouterV2;

namespace NodeBlock.Plugin.Ethereum.Nodes.Uniswap.Swap
{
    [NodeDefinition("RequestUniswapSwapNode", "Swap ETH For Exact Tokens", NodeTypeEnum.Function, "Uniswap")]
    [NodeGraphDescription("Request a swap on Uniswap for a pair")]
    [NodeSpecialActionAttribute("How to use the Uniswap Swap Block ?", "open_url", "#")]
    [NodeIDEParameters(Hidden = true)]
    public class RequestUniswapSwapNode : Node
    {
        public RequestUniswapSwapNode(string id, BlockGraph graph)
            : base(id, graph, typeof(RequestUniswapSwapNode).Name)
        {
