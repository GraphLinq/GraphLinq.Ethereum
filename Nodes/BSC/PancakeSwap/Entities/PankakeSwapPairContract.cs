...
{
    public class PankakeSwapPairContract
    {
        public partial class PankakeSwapPairDeployment : PankakeSwapPairDeploymentBase
        {
            public PankakeSwapPairDeployment() : base(BYTECODE) { }
            public PankakeSwapPairDeployment(string byteCode) : base(byteCode) { }
        }

        public class PankakeSwapPairDeploymentBase : ContractDeploymentMessage
        {
            public static string BYTECODE = "";
            public PankakeSwapPairDeploymentBase() : base(BYTECODE) { }
            public PankakeSwapPairDeploymentBase(string byteCode) : base(byteCode) { }
