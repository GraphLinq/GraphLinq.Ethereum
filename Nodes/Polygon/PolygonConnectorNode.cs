...
namespace NodeBlock.Plugin.Ethereum.Nodes.Polygon
{
    [NodeDefinition("PolygonConnectorNode", "Polygon Connector", NodeTypeEnum.Connector, "Blockchain.Polygon")]
    [NodeGraphDescription("Connection to the Polygon network, can be used as Managed connection (without in parameters) or with your own node")]
    public class PolygonConnectorNode : Node
    {
        public PolygonConnectorNode(string id, BlockGraph graph)
            : base(id, graph, typeof(PolygonConnectorNode).Name)
        {
            ...
            this.OutParameters.Add("connection", new NodeParameter(this, "connection", typeof(PolygonConnectorNode), true));
        }
        ...
        public override void SetupConnector()
        {
            ...
            {
                UseManaged = true;
                this.Web3Client = Plugin.Web3ClientPOLYGON;
                this.SocketClient = Plugin.SocketClientPOLYGON;
            }
            else
            {
                UseManaged = false;
