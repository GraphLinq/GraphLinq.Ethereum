...
{
    public class QuickswapV2ERC20
    {
        public partial class QuickswapV2ERC20Deployment : QuickswapV2ERC20DeploymentBase
        {
            public QuickswapV2ERC20Deployment() : base(BYTECODE) { }
            public QuickswapV2ERC20Deployment(string byteCode) : base(byteCode) { }
        }

        public class QuickswapV2ERC20DeploymentBase : ContractDeploymentMessage
        {
            public static string BYTECODE = "";
            public QuickswapV2ERC20DeploymentBase() : base(BYTECODE) { }
            public QuickswapV2ERC20DeploymentBase(string byteCode) : base(byteCode) { }
