...
namespace NodeBlock.Plugin.Ethereum.Nodes.Quickswap.Entities
{
    class QuickswapPair
    {
        public partial class QuickswapPairDeployment : QuickswapPairDeploymentBase
        {
            public QuickswapPairDeployment() : base(BYTECODE) { }
            public QuickswapPairDeployment(string byteCode) : base(byteCode) { }
        }

        public class QuickswapPairDeploymentBase : ContractDeploymentMessage
        {
            public static string BYTECODE = "";
            public QuickswapPairDeploymentBase() : base(BYTECODE) { }
            public QuickswapPairDeploymentBase(string byteCode) : base(byteCode) { }
